  ...
  return (
    <div className="sidebar w-[30%] h-full ">
      ...
      <div className="sidebarbuttons absolute bottom-0 w-[100%]  flex flex-col items-center gap-2 my-4">
        <button className="flex justify-center active:scale-[0.994] bg-[#D9D9D9] rounded-[4px] lg:w-[85%] xl:w-[70%] cursor-pointer  text-sm items-center px-6 h-[42px] gap-2">
          <img src="gmail.png" className="w-[20px]" />{" "}
          <span className="xl:text-base lg:text-sm">
            samiul.primary@gmail.com
          </span>
        </button>
        <button className="flex justify-center bg-[#8c28d8] xl:text-base text-sm  rounded-[4px] font-medium text-white active:scale-[0.994] lg:w-[85%] xl:w-[70%] cursor-pointer  items-center px-6 h-[42px] gap-2">
          Book a meeting
        </button>
      </div>
    </div>
